...
"""autogenerated by genpy from terrasentia_sensors/Terra_Orientation_Data.msg. Do not edit."""
import codecs
import sys
...
class Terra_Orientation_Data(genpy.Message):
  _md5sum = "e34d80bf8481ce2ab0668f1f26f72964"
  _type = "terrasentia_sensors/Terra_Orientation_Data"
...
"""
  ...
  _slot_types = ['float64','float64','float64','float64','terrasentia_sensors/Euler_Base','terrasentia_sensors/Quaternion_Base']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Terra_Orientation_Data, self).__init__(*args, **kwds)
      ...
      if self.covariance is None:
        self.covariance = terrasentia_sensors.msg.Euler_Base()
      if self.bias is None:
        self.bias = terrasentia_sensors.msg.Quaternion_Base()
    else:
      self.x = 0.
      self.y = 0.
      self.z = 0.
